...
export ZSH="/Users/runbmp/.config/oh-my-zsh"
...
# print ls -a when changing directory
autoload -U add-zsh-hook
function ls_chpwd {
    emulate -L zsh
    ls -a
}
add-zsh-hook chpwd ls_chpwd

# don't require leading . for filename matching in ls or cd for example
setopt globdots

# don't add . or .. to cd complete suggestions
